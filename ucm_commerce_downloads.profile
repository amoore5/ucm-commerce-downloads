...
function _ucm_commerce_downloads_create_product_image_field($entity_type, $bundle) {
 ...
 */
function _ucm_commerce_downloads_create_product_reference($entity_type, $bundle, $field_name = 'field_product') {
